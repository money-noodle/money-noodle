# Reviewed exposure record for the web app (#184).
#
# This file is the committed, pull-request-reviewed record that the `web`
...
# (`action: apply`, stack `web`, confirmation `CHANGE-PUBLIC-ACCESS`). See
