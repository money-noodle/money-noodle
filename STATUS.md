...
- **255 unit tests across 46 files**, passing TypeScript, and passing production build. The authoritative-provider and authenticated-dashboard build was deployed through pause/drain/reconcile/restart; temporary local `AUTH_PASSWORD`/`AUTH_SECRET` values are configured, reconciliation is ready, and live automation was explicitly resumed with zero open orders/reservations.
