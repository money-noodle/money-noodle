...
| Forecast candidate Phase 2 | At 2026-08-26T02:07Z, 91/100 closed windows had 95.30% funded-provider outcome coverage, complete six-arm families, 100% candidate availability, and zero replay error. | Some issuance rows lacked funded-provider provenance. This was wiring/coverage evidence only; production remained Blend 0.4 and neither ranking nor Phase 3 was authorized. |
