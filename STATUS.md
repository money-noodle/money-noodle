...
11. Build the provider/variant registry and policy-identity schema before adding Crypto.com, ForecastEx, or Robinhood adapters; then add each adapter read/paper-first behind explicit capabilities.
