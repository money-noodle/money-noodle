...
The follow-up does **not** support calling the recent profitability stable. It supports retaining the model weights, stake, and retry controls. Binary buy policy v11 now lets UP/YES and DOWN/NO compete on side-specific expected value only when the independent selected-side probability is at least 55%; the venue-independent probability model remains unchanged.
...
- Binary buy policy v11: at least 55% independent selected-side probability, at least 5pp expected edge after fees, at least 50% estimate quality, and an enabled actionable selected-side UP/YES or DOWN/NO entry from 5¢ through 97¢.
