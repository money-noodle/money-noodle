  ...
  return <Dialog>
    <DialogTrigger asChild>
      {variant === 'badge'
        ...
        : <Button variant="ghost" size="sm" className="text-muted-foreground" title={`Data freshness and collection cadence — ${summary}`}><span className="relative flex size-1.5"><span className={cn('inline-flex size-1.5 rounded-full', healthy ? 'bg-data' : 'bg-warn')}/></span><Clock3/><span className="hidden lg:inline">Data</span></Button>}
    </DialogTrigger>
