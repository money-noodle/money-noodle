        ...
        {loading && !data ? <div className="grid h-64 place-items-center"><Loader2 className="animate-spin text-muted-foreground"/></div> : <>
          ...
          <div className="grid gap-3 lg:grid-cols-[1fr_1.35fr]">
            <div className="rounded-xl border p-4">
              ...
              <p className="mt-1.5 text-[9px] text-muted-foreground">Maximum real-money equity Signal Desk may risk. Saving verifies this amount against signed Kalshi available cash.</p>
