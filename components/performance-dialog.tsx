...
import type { CalendarEvaluationReport, CyclePathReport, ForecastHistoryRow, MakerFillReport, ModelPromotionEntry, PerformanceSlice, PerformanceSummary, PersistenceCandidateReport, ProviderTradeRecord, SegmentGroup, TradeTrackRecord, WalkForwardEvaluationHistory } from '@/lib/types';
 ...
 * maker-execution report, and worker-local prospective policy/calendar evaluations. Everything else — calibration,
