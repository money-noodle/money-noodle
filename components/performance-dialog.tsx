...
import type { CyclePathReport, ForecastHistoryRow, MakerFillReport, ModelPromotionEntry, PerformanceSlice, PerformanceSummary, PersistenceCandidateReport, ProviderTradeRecord, SegmentGroup, TradeTrackRecord, WalkForwardEvaluationHistory } from '@/lib/types';
 ...
 * maker-execution report, and worker-local prospective policy candidate. Everything else — calibration,
