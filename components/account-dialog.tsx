...
export function AccountDialog() {
  ...
  async function load() {
    setLoading(true);
    try { setData(await fetch('/api/accounts', { cache: 'no-store' }).then((response) => response.json())); }
