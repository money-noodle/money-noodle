...
> **Current use:** Historical only — no current gate or collection authority.
> **Created:** 2026-08-17
...
> It shipped historically as buy policy v18 with `edge-spike-sentinel-v1` recording every decision the gate declined.
