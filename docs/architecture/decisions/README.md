...
| [`ADR-0010`](ADR-0010-agent-operated-production-control-plane.md) | Working | Decision and catalog only; nothing implemented or applied | Human-approved, agent-operated production control plane, operation catalog, evidence, bootstrap, and secret lifecycle |
