...
| [`ADR-0011`](ADR-0011-agent-coordination-and-isolation-protocol.md) | Working | Corrected 2026-09-08 after its first implementation | Cross-harness coordination, claim isolation, integration safety, and per-decision durability |

The Evidence column is the point of this table. ADR-0001 through ADR-0007 and ADR-0011 are **Working**: decided enough to build on, but not production-proven. ADR-0001 through ADR-0003 are exercised by repository checks, ADR-0004 through ADR-0007 have never been applied to a provider, and ADR-0011 was implemented once, found far heavier than the work it guarded, and corrected in place on 2026-09-08. ADR-0008 and ADR-0009 are **Proposed**, not Working. The lack of a production deployment prevents any record from becoming Settled; it does not promote a proposal to Working.
