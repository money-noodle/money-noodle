 ...
 * live-only maker-fill report and worker-local prospective candidate are never requested, so no
 * real-money or private evaluation record exists here to redact.
 */
